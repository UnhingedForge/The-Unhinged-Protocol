...
Phase 0 inventory generated from pinned direct and resolved transitive packages on
2026-08-19. This is a development inventory, not the final release notice. The Phase 5
binary inventory and SBOM control release contents.
...
project; third-party components retain their respective terms.

No GPL/AGPL component, telemetry SDK, plugin host, scripting engine, or cloud client is
an approved Phase 0 production dependency.
